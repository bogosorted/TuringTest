...
### Confirmação
- [ ] Arquivo .txt gerado com 3 fichas distintas
- [ ] cada ficha contém Nome, Setor, Função e Personalidade
- [ ] cruzamento de dados na interface de inspeção durante a gameplay.
